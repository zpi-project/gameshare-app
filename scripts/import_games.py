...
#     categories_pl = []
    ...
    db.connect(db.insert_game, original_id, name, name_pl, description, description_pl, min_players, max_players,
               playing_time, age, image)
    for c in categories:
        db.connect(db.insert_category, c, c_pl)
