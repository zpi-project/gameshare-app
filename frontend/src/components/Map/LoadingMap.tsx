...
const LoadingMap: FC = () => {
  ...
  return (
    <>
      <div className="absolute left-0 top-0 z-[12] h-screen w-screen backdrop-blur-[2px]" />
      <div className="absolute left-1/2 top-1/2 z-[12] h-12 w-12 -translate-x-1/2 -translate-y-1/2 transform">
        <div
