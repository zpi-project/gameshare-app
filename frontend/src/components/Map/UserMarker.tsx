...
const UserMarker: FC<UserMarkerProps> = ({ user, onClick }) => {
  ...
  const pinIcon = divIcon({
    html: `
    <svg width="30" height="52" viewBox="0 0 36 52" fill="none" xmlns="http://www.w3.org/2000/svg" class="location-marker__svg">
