...
const AddGameForm: FC<AddGameFormProps> = ({ close }) => {
  ...
  return (
    ...
    >
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="bg-background p-3">
          {step === 0 ? (
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="grid h-[200px] w-full gap-2.5 rounded-lg bg-card p-4">
                        <Textarea
            ...
            <div className="flex min-h-[500px] flex-grow flex-col justify-between gap-2">
