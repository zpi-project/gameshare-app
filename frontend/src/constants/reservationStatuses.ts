...
export const RESERVATION_STATUS_COLORS = {
  ...
  CANCELED_BY_OWNER: "bg-muted dark:bg-destructive hover:bg-destructive dark:hover:bg-destructive", // Light gray / Dark gray
  CANCELED_BY_RENTER: "bg-muted dark:bg-destructive hover:bg-destructive dark:hover:bg-destructive", // Light gray / Dark gray
