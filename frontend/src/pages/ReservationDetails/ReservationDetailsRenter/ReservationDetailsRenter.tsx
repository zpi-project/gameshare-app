      ...
      <div className="flex h-full w-full flex-col gap-4  xl:flex-row">
        <ScrollArea className="h-full flex-grow xl:max-w-[33%]">
          <div className="flex flex-col gap-4 xl:min-h-[calc(100vh-140px)]">
            <div className="relative flex-grow rounded-lg bg-section p-8">
              <div
                className="absolute left-4 right-4 top-4 rounded-lg opacity-50 dark:opacity-40"
                style={{
                  backgroundImage:
        ...
        <ScrollArea className="h-full flex-grow xl:max-w-[33%]">
          <div className="relative flex flex-grow flex-col gap-4 rounded-lg bg-section p-4">
            ...
            />
            <div className="relative flex flex-grow items-center justify-between gap-8 p-4 xl:min-h-[calc(100vh-172px)] xl:flex-col xl:gap-4">
              <GameInstanceDetails gameInstance={gameInstance} />
              <div className="flex h-[300px] w-full flex-grow flex-col gap-2 overflow-hidden rounded-lg xl:h-[400px]">
                <Map
                  location={[
