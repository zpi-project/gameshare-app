...
//TODO Query to do
    @Query(value = "select distinct *, " +
            ...
            "where GC.category_id in :categories and is_active = true " +
            "and :age >= age " +
            "and :playersNumber between min_players and max_players " +
            "ORDER BY distance;",
            nativeQuery = true)
    Page<GameInstanceListDTO> filterGameInstancesByParameters(@Param("categories") Optional<Long> categoryIds, @Param("age") Optional<Integer> age,
