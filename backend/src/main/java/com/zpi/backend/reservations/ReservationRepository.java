...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    Page<Reservation> getCurrentReservationsByRenter(Pageable pageable,@Param("uuid") String renterUuid);
    ...
    Page<Reservation> getCurrentReservationsByOwner(Pageable pageable,@Param("uuid") String OwnerUuid);
